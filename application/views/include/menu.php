    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-right pr-0">
                ...
                <a href="<?php if(!empty($_SESSION['user_id'])){echo base_url().'Loginregister'; }else{echo base_url().'Loginregister/Accountlogin';} ?>" class="d-lg-show">My Account</a>
                        ...
                        <div class="header-left">
                            <div class="dropdown category-dropdown has-border" data-visible="true">
                               ...
                               <?php foreach ($productcategory as $key => $row): ?>
                                   <li>
                                       ...
                                       <a href="<?php echo base_url('get/category/'.$row->idtbl_product_category);?>">
                            ...
                            <ul class="menu active-underline">
                                   ...
                                   <li class="<?php
                                           ...
                                           ?>"><a href="<?php echo site_url('other/contactus');?>">Contact</a> 
                                           </li>
                                           ...
                                           ?>"><a href="<?php echo site_url('other/aboutus');?>">About</a> 
                                           </li>
                                       </li>
                                   </ul>
                            </nav>
