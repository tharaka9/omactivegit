    ...
    <div class="header-top">
        <div class="container">
            <div class="header-left">
                <p class="welcome-msg">Welcome to Omactive</p>
            </div>
    ...
    <div class="header-middle">
                <div class="container">
                    <div class="header-left mr-md-4">
                        ...
                        <a href="<?php echo base_url(); ?>" class="logo ml-lg-0">
                            <img src="<?php echo base_url('assets/images/demos/demo5/Logo.jpeg');?>" alt="logo" width="145" height="45" />
                        </a>
                        <form method="get" action="#" class="header-search hs-expanded hs-round d-none d-md-flex input-wrapper">
                            <div class="select-box">
                                ...
                                <?php foreach ($productcategory as $row) { ?>
                                    <option value="<?php echo $row->idtbl_product_category;?>"><?php echo $row->product_category;?></option>
        ...
        <div class="container">
            <div class="inner-wrap">
                <div class="header-left">
                    <div class="dropdown category-dropdown " data-visible="true" id="topdropdown">
                    ...
                    <nav class="main-nav ml-4">
                        <ul class="menu active-underline">
                            ...
                            <li class="<?php if ($this->uri->uri_string() == 'shop') {echo "active";}?>">
                                <a href="#">Shop</a>
                                <ul>
                                    <?php foreach ($productcategory as $row) { ?>
                                    <li>
                            ...
                            <li class="<?php if ($this->uri->uri_string() == 'other/contactus') {echo "active";} ?>">
                                <a href="<?php echo base_url('other/contactus');?>">Contact</a>
                            </li>

                            <li class="<?php if ($this->uri->uri_string() == 'other/aboutus') {echo "active";} ?>">
