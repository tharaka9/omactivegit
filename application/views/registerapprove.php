...
<body>
    <div class="page-wrapper">
        ...
        <div class="page-header">
            <div class="container">
                <h1 class="page-title mb-0">Account Activate</h1>
            </div>
        </div>
        <!-- End of Page Header -->
                            ...
                            <div class="login-popup">
                                <div class="vendor-widget">
                                    <div class="vendor-widget-2">
                                        <?php //print_r($getotpmsg); ?>
                                        <form action="<?php echo base_url() ?>Loginregister/Accountactivate" method="post" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control text-dark" name="actsecuritycode" id="actsecuritycode" required autofocus>
                                            </div>
                                            <p>If you don't receive security code, please contact our oprator or check again email and mobile. Thank you</p>
                                            <input type="hidden" name="actuserid" id="actuserid" value="<?php echo $actuserid; ?>">
                                            <button type="submit" class="btn btn-primary w-100">Active Account</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="banner banner-newsletter">
                            <div class="banner-content text-center">
                                <h3 class="banner-title">Sign up to
                                    <strong class="text-uppercase">Omactive</strong>
                                </h3>
